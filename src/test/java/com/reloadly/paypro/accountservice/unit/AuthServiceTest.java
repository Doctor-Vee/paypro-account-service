...
public class AuthServiceTest {
    ...
    @Test
    void shouldThrowErrorWhenAttemptingToLoginWithoutProvidingUsername() {
        LoginRequest loginRequest = TestModels.createLoginRequestWithoutUsername();
        assertThrows(BadRequestException.class, () -> {
    ...
    @Test
    void shouldThrowErrorWhenAttemptingToLoginWithoutProvidingPassword() {
        LoginRequest loginRequest = TestModels.createLoginRequestWithoutPassword();
        assertThrows(BadRequestException.class, () -> {
            authService.processLogin(loginRequest);
        });
